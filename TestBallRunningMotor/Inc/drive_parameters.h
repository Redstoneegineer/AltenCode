...
#define BEMF_THRESHOLD_DOWN_ON_V 		6.2	/*!< BEMF voltage threshold during PWM ON time for zero crossing detection when BEMF is expected to decrease */
#define BEMF_THRESHOLD_UP_ON_V   		6.2	/*!< BEMF voltage threshold during PWM ON time for zero crossing detection when BEMF is expected to increase */
...
#define DEFAULT_DRIVE_MODE             VM /*!< VOLTAGE_MODE (VM) or
                                                        CURRENT_MODE (CM)*/
#define DEFAULT_TARGET_SPEED_RPM       2250
#define DEFAULT_TARGET_SPEED_UNIT      (DEFAULT_TARGET_SPEED_RPM*SPEED_UNIT/U_RPM)

/**************************    FIRMWARE PROTECTIONS SECTION   *****************/
#define OV_VOLTAGE_THRESHOLD_V          13 /*!< Over-voltage
                                                         threshold */
...
#define PHASE2_FINAL_SPEED_UNIT         (2250*SPEED_UNIT/U_RPM)
#define PHASE2_VOLTAGE_RMS             3.8
/* Phase 3 */
#define PHASE3_DURATION                500 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (2250*SPEED_UNIT/U_RPM)
#define PHASE3_VOLTAGE_RMS             3.8
/* Phase 4 */
...
#define OBS_MINIMUM_SPEED_RPM          2250
