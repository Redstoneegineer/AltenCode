...
#define PID_TORQUE_KP_DEFAULT         2405
#define PID_TORQUE_KI_DEFAULT         3206
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           2405
#define PID_FLUX_KI_DEFAULT           3206
...
#define PID_SPEED_KP_DEFAULT          2701/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          4/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define PHASE2_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A           2
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A           2
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A           2
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (1818*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A           2
