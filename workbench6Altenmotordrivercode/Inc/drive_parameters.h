...
#define MAX_APPLICATION_SPEED_RPM       9740 /*!< rpm, mechanical */
...
#define BEMF_ADC_TRIG_TIME_DPP          ((uint16_t) 716)   /*!< 1/1024 of PWM period elapsed */
...
#define SPEED_THRESHOLD_DEMAG    ((uint32_t) 6493)  /*!< Speed threshold above which the RUN_DEMAGN_DELAY_MIN is applied */
...
#define PID_SPEED_KP_DEFAULT          -777/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_DRIVE_MODE             CM /*!< VOLTAGE_MODE (VM) or
                                                        CURRENT_MODE (CM)*/
...
/******************************   BUS VOLTAGE Motor 1  **********************/
#define  M1_VBUS_SAMPLING_TIME  LL_ADC_SAMPLING_CYCLE(239)
