...
#define MAX_APPLICATION_SPEED_RPM       9738 /*!< rpm, mechanical */
...
#define BEMF_THRESHOLD_DOWN_ON_V 		6.85	/*!< BEMF voltage threshold during PWM ON time for zero crossing detection when BEMF is expected to decrease */
#define BEMF_THRESHOLD_UP_ON_V   		6.85	/*!< BEMF voltage threshold during PWM ON time for zero crossing detection when BEMF is expected to increase */
...
#define SPEED_THRESHOLD_DEMAG    ((uint32_t) 6492)  /*!< Speed threshold above which the RUN_DEMAGN_DELAY_MIN is applied */
...
#define PID_SPEED_KP_DEFAULT          1267/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_DRIVE_MODE             VM /*!< VOLTAGE_MODE (VM) or
                                                        CURRENT_MODE (CM)*/
#define DEFAULT_TARGET_SPEED_RPM       1461
